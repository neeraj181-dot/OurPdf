...
export const GoogleOneTapPrompt: React.FC<GoogleOneTapPromptProps> = ({ onAuthSuccess }) => {
  ...
  const handleSignIn = () => {
    ...
    const res = loginWithGoogle("user.google@gmail.com", "Google Account User");
    if (res.user) {
    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="flex items-center gap-2.5 mb-2">
          ...
          <div>
            <div className="text-xs font-bold text-zinc-100">Sign in with Google</div>
            <div className="text-[10px] text-zinc-400">Easy PDF Studio Pro</div>
          </div>
        </div>

        <p className="text-xs text-zinc-300 mb-3 leading-snug">
          Instantly claim 1,000 AI document processing credits with your Google Account.
        </p>
